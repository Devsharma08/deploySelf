    ...
    <div id='projects' className="min-h-screen bg-black px-6 py-6 text-white">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto text-lg sm:text-xl">
          ...
          {/* "Contact Us" divider line - Now on top */}
          <div  className="relative flex justify-center items-center mb-6"> {/* Adjusted margin-bottom */}
          ...
          {/* Icons for contact types - Now below the divider */}
          <div className="flex justify-center space-x-6 mb-8"> {/* Adjusted margin-bottom */}
          ...
          <div className="flex flex-col sm:flex-row justify-around items-center space-y-6 sm:space-y-0 sm:space-x-6 text-xl text-gray-300 mt-10">
            <p className="flex items-center">
              <a href="mailto:devsharma08072004@gmail.com" className="hover:text-white transition-colors duration-300">devsharma08072004@gmail.com</a>
            </p>
            <p className="flex items-center">
